...
2026-09-07：保留短剧创作、海外适配和 handoff 的专业约束，将阶段模板与详细检查移至按需引用；不把阶段交付变成重复审批；复审限定按请求创建文件，独立对话稿不附带项目初始化。通用授权、协作和停止规则遵循项目 [AGENTS.md](../../../AGENTS.md) 与 [项目系统提示词](../../../docs/ai-system-prompt.md)。
