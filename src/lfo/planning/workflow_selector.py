...
from lfo.planning.panel_pack import PanelPack, validate_panel_pack
...
def select_workflow_for_panel(
    ...
    *,
    ...
    - Valid PanelPack → confirmed r2v (does not inspect start_frame)
    - force_fl2va → explicit i2v override
    - Incomplete pack → blocked r2v (never silent t2va fallback)
    """
    if force_fl2va:
