...
RUN = r"E:\ideaProjects\zero-to-story\workspace\projects\开不了口的事\ep001\review\P007_v2_run_5e297812"
...
for fno, box, scale, name in [
    ...
    (min(int(9.5 * 24) + 1, 345), (150, 100, 480, 600), 2, "zoom_linran_95s.png"),
